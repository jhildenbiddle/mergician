declare module 'mergician' {
	 ...
	 * @param options
	 */
	function mergician<T extends ObjectLiteral>(options: MergicianOptions): (...objects: ObjectLiteral[]) => T;
	 ...
	 * @param options
	 */
	function mergician<T extends ObjectLiteral>(options: MergicianOptions): (options: MergicianOptions) => (...objects: ObjectLiteral[]) => T;
	 ...
	 */
	function mergician<T extends ObjectLiteral>(...objects: ObjectLiteral[]): T;
